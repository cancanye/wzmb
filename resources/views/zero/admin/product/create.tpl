                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-xxl-6">
                                                    ...
                                                    <input class="form-control mb-5" data-bs-toggle="tooltip" title="默认为0" id="class" name="class" type="number" placeholder="产品等级" value="1">
                                                ...
                                                <div class="col-xxl-6">
                                                    ...
                                                    <label class="form-label required">产品分组</label>
