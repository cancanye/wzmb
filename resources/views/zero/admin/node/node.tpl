                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <div class="card-toolbar">
                                                ...
                                                <input type="text" data-kt-admin-table-filter="search" class="form-control form-control-solid w-200px ps-15 me-3" placeholder="搜索"/>
                                                ...
                                                <a class="btn btn-primary fw-bold" href="node/create">
