						...
						<div class="card-body p-10 p-lg-20">
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="/user/dashboard" action="#">
								...
								<div class="fv-row mb-5">
									<select class="" id="email" type="email" name="email" autocomplete="new-password" placeholder="{$trans->t('email')}"/>
									<option></option>
								...
								<div class="fv-row mb-5" data-kt-password-meter="true">
									<div class="position-relative mb-3">		
										<input class="form-control form-control-lg bg-transparent" type="password" placeholder="{$trans->t('passwd')}" name="password" id="passwd" autocomplete="new-password" />
