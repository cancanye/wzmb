<?php
/* Smarty version 4.3.1, created on 2023-05-11 22:05:09
  from '/var/www/zero/resources/views/zero/include/index/menu.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_645cf6159afd16_14701901',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3a01c7963c106282eb137e0140c33a888be02db9' => 
    array (
      0 => '/var/www/zero/resources/views/zero/include/index/menu.tpl',
      1 => 1683813907,
      2 => 'file',
    ),
  ),
...
function content_645cf6159afd16_14701901 (Smarty_Internal_Template $_smarty_tpl) {
...
" />
                                                ...
                                                <div class="d-flex flex-column">
                                                    <a class="badge badge-light-success fw-bold fs-8">权限组:&nbsp; <?php echo $_smarty_tpl->tpl_vars['user']->value->getPermission($_smarty_tpl->tpl_vars['user']->value->class);?>
</a>
                                        ...
                                        <div class="menu-item px-5" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-offset="-15px, 0">
                                            <a href="#" class="menu-link px-5" id="zero_user_current_language">
                                                <span class="menu-title position-relative"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('language');?>
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link d-flex px-5" onclick="changeCurrentLanguage('en-US')">
                                                        ...
                                                        </span><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('english');?>
                                                    ...
                                                    <a href="#" class="menu-link d-flex px-5" onclick="changeCurrentLanguage('zh-CN')">
                                                        ...
                                                        </span><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('chinese');?>
                                        ...
                                        <div class="menu-item px-5">
                                            <a href="/user/logout" class="menu-link px-5 fw-bold"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('signout');?>
</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/user/dashboard">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('dashboard');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/user/order">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('order');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/user/product">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('products');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/user/node">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('node');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        ...
                                        <a class="menu-link" href="/user/ticket">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('ticket');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        ...
                                        <a class="menu-link" href="/user/profile">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('profile');?>
</span>
                                        </a>
                                    </div>
                                    ...
                                    <div class="menu-item menu-accordion">
                                        <a class="menu-link" href="/user/record">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('record');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        ...
                                        <a class="menu-link" href="/user/ban">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('ban');?>
</span>
                                        </a>
                                    </div>
                                    <div class="menu-item menu-accordion">
                                        ...
                                        <a class="menu-link" href="/user/referral">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('referral');?>
</span>
                                        </a>
                                    </div>
...
/dashboard">
                                            ...
                                            <span class="menu-title"><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('admin');?>
</span>
                                        </a>
                                    </div>
                                    <?php }?>
...
" target="_blank" class="btn btn-flex flex-center btn-custom btn-primary overflow-hidden text-nowrap px-0 h-40px w-100" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss-="click" title="点击加入我们的群组">
