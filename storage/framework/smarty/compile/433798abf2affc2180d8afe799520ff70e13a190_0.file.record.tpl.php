<?php
/* Smarty version 4.3.1, created on 2023-04-01 22:40:52
  from '/var/www/zero/resources/views/zero/user/record.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_64284274323728_55963731',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '433798abf2affc2180d8afe799520ff70e13a190' => 
    array (
      0 => '/var/www/zero/resources/views/zero/user/record.tpl',
      1 => 1680174611,
      2 => 'file',
    ),
  ),
...
function content_64284274323728_55963731 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
    <head>
                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                    <div class="card mb-9">
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            <div class="card-title">
												...
												<?php echo $_smarty_tpl->tpl_vars['trans']->value->t('signin record');?>
                                            ...
                                            <table class="table align-middle table-striped table-row-bordered text-nowrap gy-5 gs-7" id="zero_signin_log_table">
                                                <thead>
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th>IP</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('address');?>
</th>
                                    ...
                                    <div class="card mb-9">
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            <div class="card-title">
                                                <div class="fs-3 fw-bolder text-dark">
												<?php echo $_smarty_tpl->tpl_vars['trans']->value->t('using record');?>
                                    ...
                                    <div class="card mb-9">
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            <div class="card-title">
                                                <div class="fs-3 fw-bolder text-dark">
                                                    <?php echo $_smarty_tpl->tpl_vars['trans']->value->t('subscribe record');?>
                                    ...
                                    <div class="card mb-9">
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            <div class="card-title">
                                                <div class="fs-3 fw-bolder text-dark">
                                                    <?php echo $_smarty_tpl->tpl_vars['trans']->value->t('traffic record');?>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <table class="table align-middle table-striped table-row-bordered text-nowrap gy-5 gs-7" id="zero_traffic_log_table">
                                                <thead>
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">                                                       
                                                        <th><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('node name');?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('traffic');?>
</th>
                                                        <th><?php echo $_smarty_tpl->tpl_vars['trans']->value->t('date');?>
</th>
                                                    </tr>
