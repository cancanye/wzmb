...
return function (SlimApp $app) {
    ...
    $app->group('/' . $admin_path, function (Group $group) {
        ...
        // classification
        $group->group('/node_classification', function($classification) {
            $classification->get('',                       NodeClassificationController::class . ':nodeClassificationIndex');
            $classification->post('/ajax',                 NodeClassificationController::class . ':nodeClassificationAjax');
            $classification->post('/create',               NodeClassificationController::class . ':createNodeClassification');
            $classification->post('/update',               NodeClassificationController::class . ':updateNodeClassification');
